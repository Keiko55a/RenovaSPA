  ...
  <body>
    <div class="container">
      ...
      <form action="crearUsuario.php" method="post">
            ...
            <div class="col-md-4">
              ...
              <label>Favor De Seleccionar Tu Hotel:</label>
               <select name="hotel" id="">
                 <option value="1">Barcelo</option>
                 <option value="2">Holiday Xpress</option>
                 <option value="3">Secrets</option>
                 <option value="4">Hard Rock</option>
               </select>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="agencia" id="">
                  <option value="1">Altournative</option>
                  <option value="2">Viva Areobus</option>
                  <option value="3">ADO</option>
                  <option value="4">Best day</option>
                </select>
              </div>
            </div>
          </div>
              ...
              <div class="form-group">
                <label for="">Seleccione Su Tratamiento:</label>
                  <select name="tratamiento" id="">
                    ...
                    <option value="2">Masaje de pies</option>
        ...
        <div class="form-group">
          <button type="submit" class="btn btn-primary " onclick="window.print()">Registrar</button>
        </div>
      </form>
    </div>
